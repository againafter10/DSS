...
export TMP=/tmp
export ORACLE_HOSTNAME=oemadm01.oracleads.com
export DEMO_HOME=/dss/operations;           export DH=$DEMO_HOME
export DEMO_STARTUP=${DEMO_HOME}/bin  export DS=$DEMO_STARTUP
...
alias profiles='cd /dss/operations/profiles/cc'
alias startup='cd /dss/operations/bin/cc'
